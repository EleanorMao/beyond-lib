...
describe('origin test', function() {
	it('should work well', function() {
		expect(url1.origin).toEqual('http://www.domain.com:3000');
		expect(url2.origin).toEqual('https://www.domain.com');
		expect(url3.origin).toEqual('http://1.2.3.4');
	});
});
...
describe('query test', function() {
	...
	it('should work well', function() {
		...
		expect(url.parse('http://www.domain.com/first/second?').query).toEqual({});
		expect(url.parse('http://www.domain.com/first/second?a=').query).toEqual({
			a: ''
		});
		expect(url.parse('http://www.domain.com/first/second?a').query).toEqual({
			a: ''
